...
OR
python training_sts_seed_optimization.py pretrained_transformer_model_name seed_count stop_after

python training_sts_seed_optimzation.py bert-base-uncased 10 0.3
"""
