...
## Training Examples
- [augmented_sbert](augmented_sbert/) - Existent models don't perform well with less or no training data. We introduce a data augmentation approach known as Augmented SBERT ([paper]()) to solve this problem. This folder contains a step-by-step guide to train existing models with augmented-sbert approach.
